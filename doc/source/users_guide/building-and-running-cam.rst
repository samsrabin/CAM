.. _ug63-building-and-running-cam:
...
detail in :ref:`Atmospheric configurations <ug63-atmospheric-configurations>`.
...
configurations <ug63-atmospheric-configurations>`.
...
- **CAM_CONFIG_OPTS**: The settings in this variable are passed directly to
  ...
  :ref:`customizing compsets<ug63-customizing-compsets>`.
...
compsets<ug63-customizing-compsets>`.
